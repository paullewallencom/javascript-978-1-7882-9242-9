...
var _sudokuModel = __webpack_require__(300);
...
var t = createTable();
console.log(allDistinctList(getAllConstraints(t)));
t[0][0] = 9;
t[1][1] = 9;
console.log(allDistinctList(getAllConstraints(t)));
...
var renderTable = exports.renderTable = function renderTable(table) {
    return document.getElementsByClassName('js-table')[0].innerHTML = tableTemplate({ table: table });
};
