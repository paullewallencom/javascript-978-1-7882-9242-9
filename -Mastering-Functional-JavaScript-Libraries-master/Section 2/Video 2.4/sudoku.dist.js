...
exports.setCell = exports.createTable = undefined;
...
var renderTable = exports.renderTable = function renderTable(table) {
    document.getElementsByClassName('js-table')[0].innerHTML = tableTemplate({ table: table });
